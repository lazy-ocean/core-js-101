...
describe('04-date-tasks', () => {
  ...
  it.optional(
    ...
    () => {
      [
        {
          date: new Date(2016, 3, 5, 0, 0),
          expected: 0, // 0 deg
        },
        {
          date: new Date(2016, 3, 5, 3, 0),
          expected: Math.PI / 2, // 90 deg
        },
        {
          date: new Date(2016, 3, 5, 15, 0),
          expected: Math.PI / 2, // 90 deg
        },
        {
          date: new Date(2016, 3, 5, 6, 0),
          expected: Math.PI, // 180 deg
        },
        {
          date: new Date(2016, 3, 5, 18, 0),
          expected: Math.PI, // 180 deg
        },
        {
          date: new Date(2016, 3, 5, 9, 0),
          expected: Math.PI / 2, // 90 deg
        },
        {
          date: new Date(2016, 3, 5, 21, 0),
          expected: Math.PI / 2, // 90 deg
        },
        {
          date: new Date(2016, 3, 5, 14, 20),
          expected: 0.8726646259971648, // 50 deg
        },
        {
          date: new Date(2016, 3, 5, 23, 55),
